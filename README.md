...
After about two year's experience developing and maintaining the new 5.0 version of [G2](https://github.com/antvis/G2), I learned the complete process of designing a new grammar. At the same time, I observed a common point between visualization and computational art: they are **data-driven** to some extent. The difference is that visualization(information visualization more specifically) is typically driven by data derived from daily life activities, while computational art is driven by data generated by algorithm or computing.
